...
import http_sender_gateway_2 as http_sender_gateway
...
init_params = {
    (1, 10): {'a': 56,  'b': 277, 'gamma': 1.0},    #0.16816817
    (1, 20): {'a': 126, 'b': 207, 'gamma': 1.0},    #0.37837838
    (1, 30): {'a': 167, 'b': 166, 'gamma': 1.0},    #0.5015015
    (2, 10): {'a': 69,  'b': 264, 'gamma': 1.0},    #0.20720721
    (2, 20): {'a': 140, 'b': 193, 'gamma': 1.0},    #0.42042042
    (2, 30): {'a': 188, 'b': 145, 'gamma': 1.0},    #0.56456456
    (3, 10): {'a': 89,  'b': 244, 'gamma': 1.0},    #0.26726767
    (3, 20): {'a': 194, 'b': 139, 'gamma': 1.0},    #0.58258258
    (3, 30): {'a': 252, 'b': 81,  'gamma': 1.0},    #0.75675675
    (4, 10): {'a': 99,  'b': 234, 'gamma': 1.0},    #0.2972993
    (4, 20): {'a': 202, 'b': 131, 'gamma': 1.0},    #0.606606661
    (4, 30): {'a': 268, 'b': 65,  'gamma': 1.0},    #0.8048048
    (6, 10): {'a': 103, 'b': 230, 'gamma': 1.0},    #0.30930931
    (6, 20): {'a': 227, 'b': 106, 'gamma': 1.0},    #0.68168168
    (6, 30): {'a': 119, 'b': 214,  'gamma': 1.0},    #0.357357
    (8, 10): {'a': 243, 'b': 90, 'gamma': 1.0},    #0.7297297
    (8, 20): {'a': 322, 'b': 11, 'gamma': 1.0},    #0.966966
    (8, 30): {'a': 302, 'b': 31,  'gamma': 1.0},    #0
