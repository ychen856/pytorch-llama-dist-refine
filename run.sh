...
sleep 10
python3.8 client_jetson_adp2.py --ppl 30 --mode exit-rate --config config_jetson2.yaml --log 10_3_device_3_hop_test_71_1.log

sleep 10
python3.8 client_jetson_adp2.py --ppl 30 --mode exit-rate --config config_jetson2.yaml --log 10_3_device_3_hop_test_71_2.log

sleep 10
python3.8 client_jetson_adp2.py --ppl 30 --mode exit-rate --config config_jetson2.yaml --log 10_3_device_3_hop_test_71_3.log
